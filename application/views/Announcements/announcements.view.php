<div id="wrap">
    <div id="main" class="container clear-top">
        ...
        <div class="container">          
            <div class="row">
              <div class="span12">
                Retrouvez ici les dernières annonces postées par les utilisateurs.
                <br />
                    ...
                    <ul class="thumbnails">
                      ...
                      <li class="thumbnail">
                        ...
                        <div class="lienAnnonce">
                          <a href="?m=announcements&amp;a=announcement&amp;id=<?=$announcement->getElementsByTagName('id')->item(0)->nodeValue?>" class="btn btn-primary">Voir</a>
                        </div>
                      </li>
                      <?php endforeach;?> 
                      <div class="clear"></div>
